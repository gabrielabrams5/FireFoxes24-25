...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    // TODO: Measure Robot Parallel and Perpendicular positions
    ...
    public TwoWheelTrackingLocalizer(HardwareMap hardwareMap, SampleMecanumDrive drive) {
        ...
        parallelEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "lfMtr"));
        perpendicularEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "lbMtr"));
